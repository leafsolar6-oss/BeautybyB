  ...
  return (
    <div>
      ...
      <div className="border-b border-border py-3.5 md:py-5">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 flex flex-wrap items-center justify-center gap-x-4 gap-y-1.5 md:gap-10">
      ...
      {/* ===== MAIN CATEGORIES ===== */}
      <section className="py-6 md:py-12 px-5 md:px-8 border-b border-border">
        <div className="max-w-[1400px] mx-auto">
          <h2 className="font-serif text-lg md:text-2xl text-dark text-center mb-4 md:mb-8">Shop by Category</h2>
          <div className="grid grid-cols-1 gap-2.5 md:grid-cols-3 md:gap-4">
            {[
              ...
              <Link key={cat.title} href={cat.link} className="relative h-[120px] md:h-[220px] block rounded-xl overflow-hidden group">
                ...
                <div className="absolute inset-0 flex items-end">
                  <div className="p-4 md:p-5 w-full flex items-end justify-between">
                    <div>
                      <h3 className="font-serif text-base md:text-xl text-white">{cat.title}</h3>
                      <p className="text-[10px] md:text-xs text-white/70 mt-0.5">{cat.desc}</p>
                    </div>
                    <span className="text-[10px] font-bold text-white/50 md:text-sm bg-white/10 backdrop-blur-sm px-2.5 py-1 rounded-full shrink-0 ml-2">
                      {cat.count}
                    </span>
                  </div>
                </div>
      ...
      {/* ===== BESTSELLERS ===== */}
      <section className="py-6 md:py-14 px-5 md:px-8">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-end justify-between mb-5 md:mb-8">
            ...
            <Link href="/shop" className="text-[11px] md:text-xs font-semibold text-dark underline underline-offset-2 hover:no-underline transition-all">
              View All →
            </Link>
          </div>
              ...
              {bestsellers.map((product) => (
                <div key={product.id} className="product-card group">
                  <div className="relative bg-offwhite aspect-[3/4] overflow-hidden rounded-lg mb-2">
                    {product.bestseller && (
                      <span className="badge badge-best absolute top-1.5 left-1.5 z-10 text-[8px] sm:text-[10px] px-1.5 py-0.5 sm:px-2 sm:py-1">Bestseller</span>
                    )}
                    {product.image ? (
                  ...
                  <p className="text-[8px] sm:text-[10px] text-muted uppercase tracking-wider font-medium truncate">{product.brand}</p>
      ...
      {/* ===== EDITORIAL BANNERS ===== */}
      <section className="py-4 md:py-8 px-5 md:px-8">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 md:gap-4">
            <div className="relative h-[160px] md:h-[320px] overflow-hidden rounded-xl">
              ...
              <div className="absolute bottom-0 left-0 p-4 md:p-8 text-white">
                ...
                <p className="text-[10px] md:text-[12px] mt-1 opacity-80">Authentic skincare for every skin type.</p>
            ...
            <div className="relative h-[160px] md:h-[320px] overflow-hidden rounded-xl">
              ...
              <div className="absolute bottom-0 left-0 p-4 md:p-8 text-white">
                ...
                <p className="text-[10px] md:text-[12px] mt-1 opacity-80">Body mists, shimmer oils & more.</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-5 md:gap-x-4 md:gap-y-8">
              {newArrivals.map((product) => (
                <div key={product.id} className="product-card group">
                  <div className="relative bg-offwhite aspect-[3/4] overflow-hidden rounded-lg mb-2">
                    {product.newArrival && (
                      <span className="badge badge-new absolute top-1.5 left-1.5 z-10 text-[8px] sm:text-[10px] px-1.5 py-0.5 sm:px-2 sm:py-1">New</span>
                    )}
                    {product.image ? (
                      <img src={product.image} alt={product.name} className="product-image w-full h-full object-cover" loading="lazy" />
                    ) : (
      ...
      {/* ===== WHAT WE OFFER ===== */}
      <section className="py-6 md:py-14 px-5 md:px-8 bg-offwhite border-y border-border">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
            {[
              ...
              <div key={item.title} className="bg-white p-4 md:p-6 border border-border rounded-xl text-center">
                ...
                <p className="text-[10px] md:text-xs text-muted mt-1.5 leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
            {[
              ...
              <div key={i} className="bg-white p-4 md:p-6 border border-border rounded-xl">
      ...
      {/* ===== CTA ===== */}
      <section className="py-8 md:py-14 px-5 md:px-8 bg-offwhite border-t border-border">
