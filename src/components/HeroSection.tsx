      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-[1400px] mx-auto px-8 md:px-16 lg:px-24 w-full">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Decorative Element */}
            <div className="animate-fade-in-up flex items-center justify-center gap-4 mb-8">
            ...
            {/* Description */}
            <p className="animate-fade-in-up text-white/85 text-base md:text-lg font-normal leading-relaxed max-w-xl mx-auto mb-10 text-center px-4">
            ...
            {/* CTA Button */}
            <div className="animate-fade-in-up flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
              <Link
                href="#categories"
                className="btn-luxury group relative inline-flex items-center gap-3 px-9 py-4 bg-gold text-green-950 text-sm font-bold tracking-[0.15em] uppercase hover:bg-gold-light transition-all duration-500 rounded-sm"
              >
            ...
            {/* Trust Indicators */}
            <div className="animate-fade-in-up flex flex-wrap items-center justify-center gap-4 md:gap-6">
              {/* Clean Beauty Badge */}
